//save_form_1   resutlbox,loading button
//save_form_2   resultbox, waiting box
//save_form_3   bootbox, result box

//$resultbox= to display the results
//$url = to send to codeegniter via PHP
//$rd_url = if success returend !!
//$button_id = the commit button to display progress (data-loading-text="loading...")

//Save_Form_p2("#button","#alert box",$url);
//return false;
...
//$resultbox= to display the results (bootstrap alert div)
//$waitbox= to display a waiting box  (bootstrap alert)
//$url = to send to codeegniter via PHP 

//Save_Form_p2("#button","#alert box","#loading dialog",$url);
//return false;


function save_form_2($formid,$button_id,$resultbox,$waitbox,$url,$rd_url){
$($resultbox).hide(); 
   $.ajax({
      url: $url,
      type: 'POST',
...
//return false;
  ...
  function save_form_3($formid,$button_id,$resultbox,$url,$rd_url){
  $($resultbox).hide();
   $.ajax({
      url: $url,
      type: 'POST',
